...
tract_pop_df, tractPopCols = dataAndColsForMerge("input_data/NHGIS/US_2010_tract_csv/nhgis0005_ds176_20105_2010_tract.csv")
tract_cit_df, tractCitCols = dataAndColsForMerge("input_data/NHGIS/US_2010_tract_csv/nhgis0005_ds177_20105_2010_tract.csv")
...
outCols = ['StateFIPS','CongressionalDistrict','SqMiles','SqKm'] + bg_dataCols + tract_dataCols
...
for col in (bg_dataCols + tract_dataCols):
